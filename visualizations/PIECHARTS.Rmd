...
p = ggplot(virus_counts, aes(x= "",y = Freq, fill = Virus_Pathogen_ID)) + geom_bar(stat = "identity", width = 1, color = "black") + coord_polar("y", start= 0) + theme_void()
p
```
...
p = ggplot(bact_count) + geom_bar(aes(x="",y=Freq, fill = Bacteria_ID),stat = "identity", width = 1, color = "black") + coord_polar("y", start = 0) + theme_void()
p
```
...
virus_counts = data.frame(virus_counts)
virus_counts = mutate(virus_counts, Freq=Freq/n)
p = ggplot(virus_counts) + geom_bar(aes(x="",y=Freq, fill = Virus_Path_ID),stat = "identity", width =1, color  ="black") + coord_polar("y", start = 0) + theme_void()
p
```
